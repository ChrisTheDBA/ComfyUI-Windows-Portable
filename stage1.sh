...
# Download and install docopt wheel from the GitHub repository
curl -L https://github.com/GoogleCloudPlatform/gcloud-python-wheels/raw/master/wheelhouse/docopt-0.6.2-py2.py3-none-any.whl \
